  ...
  <?php
                               ...
                               print '
                                   ...
                                   <div class="alert alert-success">
										...
										<h3 style="color:Black">No Immunized Chicken list!</h3>
										All of your immunized chicken list will be shown here
									</div>';
                                       }
								?>   
...
?>
            ...
            normal'><span style='font-size:12.0pt;mso-bidi-font-size:11.0pt;font-family:
           "Times New Roman","serif"'>
			<a id="return" data-placement="top" class="btn btn-success" title="Click to Return" href="pages/tables/immune.php"><i class="icon-arrow-left"></i> Back</a></p>		
			<script type="text/javascript">
			$(document).ready(function(){
			$('#return').tooltip('show');
			$('#return').tooltip('hide');
...
<p class=MsoNormal style='margin-bottom:0in;margin-bottom:.0001pt;line-height:
normal'><span style='font-size:12.0pt;mso-bidi-font-size:11.0pt;font-family:
"Times New Roman","serif"'>List of Immunized Chickens  <o:p></o:p></span></p>
