    ...
    <section class="content">
        <div class="container-fluid">
            ...
            <div class="row clearfix">
               ...
               <a type="button" href = "datatables/print_immune.php" class="btn  waves-effect m-r-20 bg-green pull-left" style = "margin-right:50px;">Reports</a>
                            
                
                              <a rel="facebox" href="add_immune.php" class="btn bg-deep-orange waves-effect" ><h2>Add Immunization</h2></a>               
                                     ...
                                     <input type="hidden" name="id" value="'.$row['cock_id'].'">
                                                ...
                                                <div class="dropdown">
                                                    ...
                                                    <ul class="dropdown-menu" role="menu" aria-labelledby="dLabel">
                                                        <li><a rel = "facebox" href="edit_immune.php?id='.$row['immune_id'].'">Update</a>
