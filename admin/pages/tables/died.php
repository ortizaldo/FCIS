            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        <div class="header">
                            <h2>
                     Died Chicken  <sspan class="label bg-blue"><?php echo $died ?></span>
                            </h2>
               ...
               <a type="button" href = "datatables/print_died.php" class="btn  waves-effect m-r-20 bg-green pull-left" style = "margin-right:50px;">Print</a>
