            ...
            <div class="row clearfix">
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        ...
                        <div class="header">
							...
							<center>
                                <div class="col-xs-12 col-sm-12">
									  ...
									  <form class="form-horizontal row-fluid" action="../../action/cock_out.php" method="POST">
	                           <select class="form-control show-tick " name="cock_id"   data-show-subtext="true"   data-live-search="true">
						          <option  value="<?php $row['cock_id']; ?>" > Select cock... </option>
                                      <?php
                                                   ...
                                                   while($row = $result->fetch_assoc()) {
                                                       echo '<option  value="'.$row['cock_id'].'"> '.$row['cock_id'].' Racist '.$row['cock_categories'].'</option>';
                                                         }
                                                    } else {
				   ...
				   <?php
								...
								include '../../../config/db_config.php';
								$id=$_GET['invoice'];
								$sql = "SELECT * FROM patient_cocks ORDER BY  date_admitted";
                                $result = $conn->query($sql);
