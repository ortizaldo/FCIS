                    ...
                    <li>
                        ...
                        <ul class="ml-menu">
                            ...
                            <li>
                                ...
                                <ul class="ml-menu">
                                    <li>
                                        <a href="pages/widgets/infobox/infobox-1.html">Owner information</a>
                                    </li>
                                </ul>
                            </li>
                        </ul>
                        ...
                        <ul class="ml-menu">
                            ...
                            <li>
                                <a href="father.php">Sire</a>
                            
                                  <a href="mother.php">Dam</a>
                                  <a href="breed.php">Breed</a>
                                  <a href="mate.php">Mating Information</a>
                            </li>
                        </ul>
                    </li>
                           <li>
                        ...
                        <ul class="ml-menu">
                            ...
                            <li>
                                  ...
                                  <a href="deworming.php">Deworming</a>
                                  <a href="vaccination.php">Vaccination</a>
                                  <a href="immune.php">Immunization</a>
                    ...
                    <li>
                        <a href="javascript:void(0);" class="menu-toggle">
                            ...
                            <span>Manage Record</span>
                             ...
                             <a href="chickens.php">Fowl Information</a>
                            
                           
                             <a href="javascript:void(0);" class="menu-toggle">Categories
                             </a>
                           

                             <ul class="ml-menu">
                                <a href="chicks.php">Chicks</a>
                                <a href="stugs.php">Stags</a>
                                 <a href="bull_stugs.php">Bull Stags</a>
                              <a href="cocks.php">Fighting Cocks</a>
                     ...
                     <li>
                        <a href="javascript:void(0);" class="menu-toggle">
                            <i class="material-icons">view_list</i>
                            <span>Create Conditioning Program</span>
                        </a>
                    
                              <ul class="ml-menu">
                              
                             <a href="conditioning.php">Conditioning Event</a>
                             ...
                             <ul class="ml-menu">
                                <a href="cfeed.php">Feeding</a>
                                <a href="cvacc.php">Vaccination</a>
                                 <a href="cprac.php">Practices</a>
