...
<form class="form-horizontal row-fluid" action="../../action/update-cvaccine.php" method="POST">
           <center>
          <h4>Fighting Cock Vaccination Details</h4>       
                           ...
                           value = "<?php echo $cvacc_id  ?>" name = "id">
                        ...
                        <datalist id="father">
                          ...
                          ?>
                                        ...
                                        <div class="form-group form-float">
                                <div class="form-line">
                        Date Vaccination: <input type="date"  value = "<?php echo $date_cvacc;  ?>" class="form-control" 
