    ...
    <section class="content">
        <div class="container-fluid">
            ...
            <div class="row clearfix">
               ...
               <a type="button" href = "datatables/print_chicken.php" class="btn  waves-effect m-r-20 bg-green pull-left" style = "margin-right:50px;">Reports</a>
             ...
             include '../../../config/db_config.php';
                 ...
                 while($row = $result->fetch_assoc()) {
                  ...
                  $no_days = $row['no_days'];
                                ...
                                ?> 
    <tr>
      <td><img src="../../action/image/<?php echo $image;?>" class = "thumbnail" style ="height:70px; width:120px;no-repeat center top;"></td>
      ...
      <td>
                                                ...
                                                <div class="dropdown">
                                                    ...
                                                    <ul class="dropdown-menu" role="menu" aria-labelledby="dLabel">
                                                      <li><a  href="chicken_information.php?id=<?php echo $row['prim_id']; ?>">View Full Info</a>
                                                        <li><a rel = "facebox" href="edit_chicken.php?id=<?php echo $row['prim_id']; ?>">Edit</a>
