...
<form class="form-horizontal row-fluid"  action="../../action/new-feed.php" method="POST">
           <center>  
           <h4>Feeding Details</h4>    
                        ...
                        Date of Feeding: <input type="date" class="form-control" 
                         ...
                         >
                                ...
                                <div class-"form-line">
                               Feeds Name: <input class="form-control" placeholder="Feeds Name" type="text" name="type_feed" >
