        ...
        <div class="container-fluid">
            ...
            <div class="row clearfix">
                        ...
                        <div class="header">
                           ...
                           List of Stags
                            ...
                            <ul class="header-dropdown m-r--5">
                                <li class="dropdown">
									<a type="button" rel = "facebox" href = "add_stug.php" class="btn  waves-effect m-r-20 bg-orange">Add Stag</a>
              ...
              $date_transfered = ''.date('M').'-'.date('d').'-'.date('Y');      
                 $sql = "SELECT * FROM chickens WHERE chicken_categories = 'Stag' and day_to_transfer = '$date_transfered'; ";
...
<td class="center">
                                                ...
                                                <div class="dropdown">
                                                    ...
                                                    <ul class="dropdown-menu" role="menu" aria-labelledby="dLabel">
                                                        ...
                                                        <li><a href="../../action/delete_stug.php?ref='.$row['chicken_id'].'">Delete</a></li>
                                                    </ul>
                                                </div>
                                            </div>
                                        </div>
