                        ...
                        <div class="header">
                           ...
                           List of chicks
                            ...
                            <ul class="header-dropdown m-r--5">
                                <li class="dropdown">
									<a type="button" rel = "facebox" href = "add_chick.php" class="btn  waves-effect m-r-20 bg-orange">Add Chick</a>
...
<td class="center">
                                                ...
                                                <div class="dropdown">
                                                    ...
                                                    <ul class="dropdown-menu" role="menu" aria-labelledby="dLabel">
                                                        ...
                                                        <li><a rel = "facebox" href="edit_chicks.php?id='.$row['chicken_id'].'">Edit</a>
                                                        <li><a href="../../action/delete_chick.php?ref='.$row['chicken_id'].'">Delete</a></li>
                                                    </ul>
                                                </div>
                                            </div>
                                        </div>
