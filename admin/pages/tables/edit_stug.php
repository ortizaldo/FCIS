...
?>
                            ...
                            <form action = "../../action/edit_stug.php" method= "POST">
                        ...
                        Born day: <input type="date" class="form-control" 
                         ...
                         name="day_to_transfer" placeholder="Day transfer" 
                          value = "<?php echo $day_to_transfer ?>">
                           ...
                           Handler :<input type="text" class="form-control show-tick" name = "handler"  value = "<?php echo $handler?>"  autocomplete = "off" list="handler">
                        <datalist id="handler">
