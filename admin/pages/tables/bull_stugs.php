        ...
        <div class="container-fluid">
            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                  ...
                  <a type="button" href = "datatables/print_bullstag.php" class="btn  waves-effect m-r-20 bg-green">Reports</a>
                ...
                <?php
                                 include '../../../config/db_config.php';
                                       ...
                                       $sql = "SELECT * FROM chickens where chicken_categories = 'Bull Stag'  ;";
