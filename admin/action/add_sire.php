...
$sql = "INSERT INTO chickens (chicken_id,chicken_categories,bloodline,no_days,handler,type)
VALUES ('$chick_id','$chicken_categories','$bloodline', '$no_days', '$handler','$type')";
