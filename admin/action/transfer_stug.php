...
if ($conn->query($sql) === TRUE) {
  ...
  $sql1 = "INSERT INTO bull_stag_his (chicken_id,chicken_categories,chicken_father_id,father_bloodline,chicken_mother_id,age,no_days,day_to_transfer,date_transfered,bloodline,prim_id,image)
...
if ($conn->query($sql1) === TRUE) {
    header("location:../pages/tables/bull_stugs.php?in=chicken $id have been registered");
} else {
