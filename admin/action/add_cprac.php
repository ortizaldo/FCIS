...
<form class="form-horizontal row-fluid"  action="../../action/new-cprac.php" method="POST">
           <center>  
           <h4>Details of Fighting Cock</h4>     
                        ...
                        <datalist id="father">
                          ...
                          ?>
                                        ...
                                        <div class="form-group form-float">
                                <div class="form-line">
                        Date of Practice: <input type="date" class="form-control" 
                         ...
                         >
                                ...
                                <div class-"form-line">
                                Description: <input class="form-control" placeholder="Description" type="text" name="descrip" >
